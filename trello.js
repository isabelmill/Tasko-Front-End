...
// <BoardDetails> => <GroupList v-for>
// <GroupList> => <CardPreview v-for>
// <CardDetails> (+edit) - initially can be loaded in seperate route (later on we can place it in a modal and nested route)
